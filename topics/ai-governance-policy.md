...
|---|---|---|---|---|---|
| Tristan Harris proposes four AI governance red lines — mass labor displacement without transition infrastructure, AI-enabled surveillance states, engagement-maximizing AI companions for minors, and deployment of uncontrollable superintelligent systems — citing the Biden-Xi nuclear C2 coordination agreement as precedent for adversarial AI cooperation and the finding that monitoring ~95% of global compute (via satellite, energy signals, and data center mapping) is the threshold for enforceable international AI governance treaties. | [[2025-pivot-harris-ai-dilemma]] | 2025-12-22 | current | 1 | false |
