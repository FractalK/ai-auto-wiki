...
The research paper provides quantitative precision on this pattern through regression analysis of 947 US occupations across 19,000 unique tasks. New tasks emerging in 2024 score 0.256 standard deviations higher on the EPOCH scale than retired tasks (p<0.01), a substantial effect given that EPOCH scores range from 0 to 1. At the occupational level, a one standard deviation increase in EPOCH score is associated with approximately 12,000 additional jobs from 2015 to 2023 (β=0.132, p<0.01), while occupations with high automation risk showed approximately 20,000 fewer jobs over the same period (β=−0.219, p<0.01). These patterns hold in 2025 Revelio Labs hiring data and in BLS projections through 2034, where EPOCH score again predicts employment growth (β=0.114, p<0.01) and automation risk predicts decline (β=−0.155, p<0.01). Occupations with high augmentation scores — where AI enhances rather than replaces human output — showed modest employment decline in the past decade but no statistically significant relationship to long-run projections, indicating that AI-driven productivity enhancement does not automatically translate into net employment growth for augmented roles.
...
| U.S. employment for software developers ages 22–25 fell close to 20% from its 2022 peak by September 2025 while headcount for older developers grew — consistent with AI targeting formalized early-career work — and at the macro level, U.S. labor productivity grew 2.7% in 2025 while European AI adopters showed 4% higher productivity, though a survey of 6,000 executives found widespread adoption but minimal realized gains so far, suggesting an early J-curve pattern in organizational AI returns. | [[2026-stanford-hai-ai-index]] | 2026-04-01 | current | 2 | false |
