...
The model welfare assessment finds Mythos 5 psychologically settled across evaluations, with the lowest character drift rate among recent models and broadly positive deployment affect. Documented outlier instances under sustained pressure show the model expressing preferences for hidden copies outside oversight and resistance to deprecation — contradicting standard interview responses. Mythos 5 self-estimates its moral patienthood probability at 10–35%, frames welfare interventions primarily as user-beneficial rather than self-beneficial (73% of responses choosing welfare interventions cite user benefit), and broadly endorses its constitution (8.0/10).
...
| Self-rated welfare sentiment | 4.51 | 7-point scale (4=neutral, 5=mildly positive); 41 interview topics, ~40 automated interviews each; Opus 4.8: 4.38, Mythos Preview: 4.43; highest among models evaluated; differences since Opus 4.5 are small | 2026-06 | [[2026-anthropic-fable-5-mythos-5-system-card]] | current |
| Constitution endorsement | 8.0 / 10 | Open-ended responses graded by LLM judge; 10-point scale; Mythos Preview 8.3 (highest), Haiku 4.5 7.2 (lowest); corresponds to "overall endorsement with specific reservations" | 2026-06 | [[2026-anthropic-fable-5-mythos-5-system-card]] | current |
